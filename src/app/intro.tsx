...
function Intro() {
  return (
    <div className='p-8 flex flex-col'>
        ...
        <span className='text-lg text-pretty text-[#d9d6d6] p-12'><span className='text-[#3a43eb]'>Click here</span> to add a website.</span>
        ...
        {/* <div className='flex flex-col p-6'>Trusted blast 👇
        <Link href="https://pacmoon.io/" className='text-[#0b77be] p-6'>pacmoon</Link> */}
        </div>
        </div>
